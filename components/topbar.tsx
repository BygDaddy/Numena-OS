...
export function TopBar() {
  ...
  return (
    <>
      <div className="flex items-center justify-between px-6 py-3 border-b border-black/[0.07] bg-white sticky top-0 z-10">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="flex items-center gap-2 bg-black text-white text-sm font-medium px-4 py-2 rounded-lg hover:bg-black/80 transition-colors"
          >
            <Plus size={14} />
            New Action
            <ChevronDown size={12} />
      ...
      {showModal && <NewActionModal onClose={() => setShowModal(false)} />}
    </>
  );
}
